...
// Importing assets
import bg from 'images/subscribers/create/bg_15.png';
import activate from 'images/subscribers/create/activate.png';
...
const Activate = ({setPage, setImage}) => {
        ...
        <View style={styles.body}>
          ...
          <View style={styles.content}>
            ...
            <Text style={styles.description}>
              Subscriber profile has been successfully created
            </Text>
            {/* Form details */}
            <View style={styles.detailsWrapper}>
              <Image source={activate} style={styles.successImage} />
              <View style={styles.infoWrapper}>
                <Text style={styles.infoTitle}>Arun Ashok</Text>
                <Text style={styles.infoSubTitle}>125346354536</Text>
              </View>
              <View style={styles.actionWrapper}>
                <AccentButtonTwo title={'Verify Phone Number'} />
              </View>
              <TouchableOpacity style={styles.nextWrapper}>
                <Text style={styles.nextWrapperText}>Go to Profile</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  infoTitle: {
    ..._Text(FontSize.large, Family.bold, Colors.userSubText),
  },
  infoSubTitle: {
    ..._Text(FontSize.smallVariantPlus, Family.bold, Colors.description_1),
  },
  nextWrapper: {
    borderBottomColor: Colors.cancelBtn,
    borderBottomWidth: 1,
    borderStyle: 'dashed',
