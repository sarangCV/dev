...
const EnterpriseIdentity = ({setPage, setImage}) => {
        ...
        <ScrollView>
          ...
          <View style={styles.body}>
            ...
            <View style={styles.content}>
              <Text style={styles.title}>Enterprise Subscriber</Text>
              ...
              <View style={styles.detailsWrapper}>
                ...
                <View style={styles.inputWrapper}>
                  <Input
                    ...
                    placeholder={'Name of GST Holder'}
                ...
                <View style={styles.inputWrapper}>
                  <Text style={styles.dobLabel}>* GST Registration Date</Text>
