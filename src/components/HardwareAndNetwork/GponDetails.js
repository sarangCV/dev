...
// Importing assets
import bg from 'images/subscribers/hardware_network/bg_2.png';
      ...
      <ScrollView>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.content}>
            <Text style={styles.title}>Gpon ONT/ONU Details</Text>
            ...
            <View style={styles.detailsWrapper}>
              ...
              <View style={styles.inputWrapper}>
                <Text style={styles.dobLabel}>GPON SN</Text>
                <DropdownPicker
                  schema={{
                    label: 'name',
                    value: 'slug',
              ...
              {/* ONT CPE MAC */}
              <View style={styles.inputWrapper}>
                <Text style={styles.dobLabel}>ONT CPE MAC</Text>
                <DropdownPicker
                  schema={{
                    label: 'name',
                    value: 'slug',
              ...
              {/* ONT/ONU Type */}
              <View style={styles.inputWrapper}>
                <Text style={styles.dobLabel}>ONT/ONU Type</Text>
                <DropdownPicker
                  schema={{
                    label: 'name',
                    value: 'slug',
              ...
              {/* ONT/ONU Make */}
              <View style={styles.inputWrapper}>
                <Text style={styles.dobLabel}>ONT/ONU Make</Text>
                <DropdownPicker
                  schema={{
                    label: 'name',
                    value: 'slug',
              ...
              <View style={styles.radioWrapper}>
                ...
                />
                <Text style={styles.radioLabel}>Auto_mac_Bind</Text>
              </View>
