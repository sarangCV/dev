...
const LcoSelectView = ({setPage, data}) => {
  ...
  const onSubmitHandler = () => {
    navigation.navigate('CreateSubscriberScreen', {lcoSlug: selectedArea});
  };

  console.log('FROM SELECT AREA', accessToken);
        ...
        <View style={styles.content}>
          ...
          <View style={styles.detailsWrapper}>
            ...
            <View style={styles.actionWrapper}>
              <AccentButtonTwo title={'Proceed'} onPress={onSubmitHandler} />
            </View>
          </View>
        </View>
      </View>
