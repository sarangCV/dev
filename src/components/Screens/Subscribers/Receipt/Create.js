...
// Importing assets
import bg from 'images/Receipt/create/bg.png';
...
const GenerateReceipt = ({setPage, setImage}) => {
  ...
  //   return styles(connectionType).layoutBg;
  // };
  ...
  //   console.log('FATHER SALUTATION', connectionType);
  // };

  return (
    <View style={styles.container}>
      {/* Header section */}
      <Header title={'Create Receipt'} wallet={true} />
      <ScrollView>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.content}>
            ...
            <View style={{paddingVertical: scaleSize(10)}}></View>
            <View style={styles.userWrapper}>
              <Image source={user} style={styles.userIcon} />
              <View>
                <Text style={styles.userTitle}>Ranjith M</Text>
                <Text style={styles.userDescription}>3209007000500003</Text>
              </View>
            </View>
            {/* Form details */}
            <View style={styles.detailsWrapper}>
              ...
              <View style={styles.inputWrapper}>
                <Text style={styles.dobLabel}>Band Type</Text>
                <DropdownPicker
                  schema={{
                    label: 'name',
                    value: 'slug',
