...
import history from 'images/subscribers/history.png';
import recharge_bill from 'images/subscribers/recharge_bill.png';
import otherBill from 'images/subscribers/other_bill.png';
import generateBill from 'images/subscribers/generate_bill.png';
import hwDetails from 'images/subscribers/hw_details.png';
import doc from 'images/subscribers/other_bill.png';
...
const SubscriberInfoView = () => {
  ...
  const subInfoData = [
    {
      ...
      title: 'History',
      image: history,
      navigateTo: () => navigation.navigate(Screens.SUBSCRIBER_HISTORY),
    },
    {
      id: 2,
    ...
    },
    {
      ...
      title: 'HW / NW Details',
      image: hwDetails,
      navigateTo: () => navigation.navigate(Screens.HARDWAREANDNETWORK),
    },
    {
      id: 6,
      title: 'Docs',
      image: doc,
      navigateTo: () => navigation.navigate(Screens.SUBSCRIBER_DOCUMENTS),
    },
  ];

  const {
    subscriberDetailSuccess,
  ...
  useEffect(() => {
    dispatch(subscriberDetail({tokenId: accessToken, slug: slug}));
  }, []);
  ...
  console.log('from subscriber details==>>', subscriberDetailData);
                  ...
                  <View style={styles.innerWrapperTop}>
                    <View style={styles.detailsWrapper}>
                      ...
                      <View style={styles.userDetailWrapper}>
                        <View style={styles.userNameWrapper}>
                          <Text style={styles.userText}>{net_id}</Text>
                          <Image
                            source={online}
                    ...
                    <View style={styles.actionWrapper}>
                      ...
                      <TouchableOpacity style={styles.activeWrapper}>
                        <Text style={styles.activeText}>{customer_status}</Text>
                      </TouchableOpacity>
                    </View>
                  </View>
                  ...
                  <View style={styles.currentPlanWrapper}>
                      ...
                      <View style={styles.topWrapperHalf}>
                        <View style={styles.currentPlanActionWrapper}>
                          ...
                          <TouchableOpacity style={styles.flashAction}>
                            <Text style={styles.flashText}>{plan_name}</Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                    </View>
                    <View style={styles.currentPlanBottomWrapper}>
                      <View style={styles.bottomTextWrapper}>
                        ...
                        <Text style={styles.bottomTextRate}>
                          {plan_renewal_fee}
                        </Text>
                      </View>
                  ...
                  <ListItem.Accordion
                    ...
                    <View style={styles.accordionContentWrapper}>
                      ...
                      <View style={styles.accordionContentRow}>
                        ...
                        <Text style={styles.accordionText}>{email}</Text>
                      </View>
                      <View style={styles.accordionContentRow}>
                        <Text style={styles.accordionLabel}>
                      ...
                      <View style={styles.accordionContentRow}>
                        ...
                        <Text style={styles.accordionText}>{mobile}</Text>
                      </View>
                      <View style={styles.accordionContentRow}>
                        <Text style={styles.accordionLabel}>Net ID :</Text>
                        <Text style={styles.accordionText}>{net_id}</Text>
                      </View>
...
export default SubscriberInfoView;
